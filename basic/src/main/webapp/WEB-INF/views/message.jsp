	...
	<section id="fh5co-home" data-section="home"
		...
		<div class="container">
			<div class="text-wrap" style="top: 100px;  background-color: white;">
				<p style="padding: 20px 0px 0px 20px"><font size="7"  color="red" face="궁서체">메일 읽기</font></p>
				<p style="padding: 0px 40px 0px 20px"><font size="6" color="#000000 face="궁서체">받는사람 : ### 보낸이 : ###</font></p>
			
			<div class="col-md-12 text-center" style="padding-left: 50px">

					<table>
						<p
							style="font-weight: bold; border: 5px solid #52D3AA; color: #F781BE; padding: 50px">Far
					...
					<div class="form-group" style="padding: 40px;" align="center";>
						<input class="btn btn-primary btn-lg" type="button" value="삭제" /> <a href="#"><input
							class="btn btn-primary btn-lg" value="확인" type="button"></a>
					</div>
				</div>
			</div>
