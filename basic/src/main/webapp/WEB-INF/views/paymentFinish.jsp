...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<meta name="author" content="FREEHTML5.CO" />
	  ...
	  function showPopup() { open("NewFile2.jsp"); }
	  </script>
  <!-- 
	//////////////////////////////////////////////////////
  			...
  			<div class="text-wrap" style="top:100px; background-color: white;" align="center">	
  				<div class="row row-bottom-padded-md">	
					...
					<div class="col-md-6 to-animate" style="width: 1000px; top: 100px;padding-left: 200px;" align="center">					
						<h3><font size="12px" style="font-variant: bold;">결제가 완료되었습니다!</font></h3>
						<img alt="이미지 없음" src="elate-master/images/full_image_2.jpg"width="500" height="300">
						<div class="form-group" style="padding: 50px;">
							<a href="index.html"><input class="btn btn-primary btn-lg" type="button" value="메인으로 돌아가기" /></a>
							<a href="index.html"><input class="btn btn-primary btn-lg" value="마이 페이지 보러가기" type="submit"></a>				
						</div>
					</div>	
					</div>			
				</div>
